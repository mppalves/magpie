...
$Ifi "%livestock%" == "lvtk_nov20" $include "./modules/70_livestock/lvtk_c_nov20/realization.gms"
$Ifi "%livestock%" == "lvtk_nov20" $include "./modules/70_livestock/lvtk_f_nov20/realization.gms"
