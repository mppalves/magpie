...
if (sum(sameas(t_past,t),1) = 1,
 ...
 if (sum(sameas(t_past,t),1) <> 1,
	...
	p70_total_lvstk(t,i) = - 3.011e+03 + 5.154e-02 * im_gdp_pc_ppp(t,i) + 2.689e+03 * vm_dem_food.l(i,"livst_milk") + 4.313e+03 * p70_livestock_conversion(t,j) + 3.924e+01 * im_pop(t,i) + 3.272e+03 * im_urb_ratio(t,i) - 3.739e-02 * im_gdp_pc_ppp(t,i) * vm_dem_food.l(i,"livst_milk") + 1.388e+02 * vm_dem_food.l(i,"livst_rum") * vm_dem_food.l(i,"livst_milk") - 9.000e-02 * im_gdp_pc_ppp(t,i) * p70_livestock_conversion(t,j) - 3.443e+03 * vm_dem_food.l(i,"livst_milk") * p70_livestock_conversion(t,j) - 1.479e-03 * im_gdp_pc_ppp(t,i) * im_pop(t,i) - 1.667e+01 * vm_dem_food.l(i,"livst_rum") * im_pop(t,i) - 1.356e+01 * vm_dem_food.l(i,"livst_milk") * im_pop(t,i) - 5.604e+01 * p70_livestock_conversion(t,j) * im_pop(t,i) + 1.420e+02 * vm_dem_food.l(i,"livst_rum") * im_urb_ratio(t,i) - 4.321e+03 * vm_dem_food.l(i,"livst_milk") * im_urb_ratio(t,i) - 5.034e+03 * p70_livestock_conversion(t,j) * im_urb_ratio(t,i) - 5.300e+01 * im_pop(t,i) * im_urb_ratio(t,i) + 5.885e-02 * im_gdp_pc_ppp(t,i) * vm_dem_food.l(i,"livst_milk") * p70_livestock_conversion(t,j) - 3.202e+02 * vm_dem_food.l(i,"livst_rum") * vm_dem_food.l(i,"livst_milk") * p70_livestock_conversion(t,j) + 9.057e-04 * im_gdp_pc_ppp(t,i) * vm_dem_food.l(i,"livst_rum") * im_pop(t,i) + 4.901e-04 * im_gdp_pc_ppp(t,i) * vm_dem_food.l(i,"livst_milk") * im_pop(t,i) + 1.154e+00 * vm_dem_food.l(i,"livst_rum") * vm_dem_food.l(i,"livst_milk") * im_pop(t,i) + 2.115e-03 * im_gdp_pc_ppp(t,i) * p70_livestock_conversion(t,j) * im_pop(t,i) + 2.392e+01 * vm_dem_food.l(i,"livst_rum") * p70_livestock_conversion(t,j) * im_pop(t,i) + 1.878e+01 * vm_dem_food.l(i,"livst_milk") * p70_livestock_conversion(t,j) * im_pop(t,i) - 4.395e-03 * im_gdp_pc_ppp(t,i) * vm_dem_food.l(i,"livst_rum") * im_urb_ratio(t,i) + 5.435e-02 * im_gdp_pc_ppp(t,i) * p70_livestock_conversion(t,j) * im_urb_ratio(t,i) + 5.310e+03 * vm_dem_food.l(i,"livst_milk") * p70_livestock_conversion(t,j) * im_urb_ratio(t,i) + 2.217e-03 * im_gdp_pc_ppp(t,i) * im_pop(t,i) * im_urb_ratio(t,i) + 2.527e+01 * vm_dem_food.l(i,"livst_rum") * im_pop(t,i) * im_urb_ratio(t,i) + 2.057e+01 * vm_dem_food.l(i,"livst_milk") * im_pop(t,i) * im_urb_ratio(t,i) + 7.641e+01 * p70_livestock_conversion(t,j) * im_pop(t,i) * im_urb_ratio(t,i) + 1.225e-02 * im_gdp_pc_ppp(t,i) * vm_dem_food.l(i,"livst_rum") * vm_dem_food.l(i,"livst_milk") * p70_livestock_conversion(t,j) - 5.997e-05 * im_gdp_pc_ppp(t,i) * vm_dem_food.l(i,"livst_rum") * vm_dem_food.l(i,"livst_milk") * im_pop(t,i) - 1.293e-03 * im_gdp_pc_ppp(t,i) * vm_dem_food.l(i,"livst_rum") * p70_livestock_conversion(t,j) * im_pop(t,i) - 7.245e-04 * im_gdp_pc_ppp(t,i) * vm_dem_food.l(i,"livst_milk") * p70_livestock_conversion(t,j) * im_pop(t,i) - 1.505e+00 * vm_dem_food.l(i,"livst_rum") * vm_dem_food.l(i,"livst_milk") * p70_livestock_conversion(t,j) * im_pop(t,i) - 2.680e-02 * im_gdp_pc_ppp(t,i) * vm_dem_food.l(i,"livst_milk") * p70_livestock_conversion(t,j) * im_urb_ratio(t,i) + 2.772e+02 * vm_dem_food.l(i,"livst_rum") * vm_dem_food.l(i,"livst_milk") * p70_livestock_conversion(t,j) * im_urb_ratio(t,i) - 1.407e-03 * im_gdp_pc_ppp(t,i) * vm_dem_food.l(i,"livst_rum") * im_pop(t,i) * im_urb_ratio(t,i) - 6.859e-04 * im_gdp_pc_ppp(t,i) * vm_dem_food.l(i,"livst_milk") * im_pop(t,i) * im_urb_ratio(t,i) - 2.071e+00 * vm_dem_food.l(i,"livst_rum") * vm_dem_food.l(i,"livst_milk") * im_pop(t,i) * im_urb_ratio(t,i) - 3.157e-03 * im_gdp_pc_ppp(t,i) * p70_livestock_conversion(t,j) * im_pop(t,i) * im_urb_ratio(t,i) - 3.663e+01 * vm_dem_food.l(i,"livst_rum") * p70_livestock_conversion(t,j) * im_pop(t,i) * im_urb_ratio(t,i) - 2.764e+01 * vm_dem_food.l(i,"livst_milk") * p70_livestock_conversion(t,j) * im_pop(t,i) * im_urb_ratio(t,i) + 7.638e-05 * im_gdp_pc_ppp(t,i) * vm_dem_food.l(i,"livst_rum") * vm_dem_food.l(i,"livst_milk") * p70_livestock_conversion(t,j) * im_pop(t,i) - 1.860e-02 * im_gdp_pc_ppp(t,i) * vm_dem_food.l(i,"livst_rum") * vm_dem_food.l(i,"livst_milk") * p70_livestock_conversion(t,j) * im_urb_ratio(t,i) + 1.011e-04 * im_gdp_pc_ppp(t,i) * vm_dem_food.l(i,"livst_rum") * vm_dem_food.l(i,"livst_milk") * im_pop(t,i) * im_urb_ratio(t,i) + 2.013e-03 * im_gdp_pc_ppp(t,i) * vm_dem_food.l(i,"livst_rum") * p70_livestock_conversion(t,j) * im_pop(t,i) * im_urb_ratio(t,i) + 1.006e-03 * im_gdp_pc_ppp(t,i) * vm_dem_food.l(i,"livst_milk") * p70_livestock_conversion(t,j) * im_pop(t,i) * im_urb_ratio(t,i) + 2.569e+00 * vm_dem_food.l(i,"livst_rum") * vm_dem_food.l(i,"livst_milk") * p70_livestock_conversion(t,j) * im_pop(t,i) * im_urb_ratio(t,i) - 1.245e-04 * im_gdp_pc_ppp(t,i) * vm_dem_food.l(i,"livst_rum") * vm_dem_food.l(i,"livst_milk") * p70_livestock_conversion(t,j) * im_pop(t,i) * im_urb_ratio(t,i);
