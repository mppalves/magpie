...
$Ifi "%yields%" == "management_mar21" $include "./modules/14_yields/management_mar21/realization.gms"
$Ifi "%yields%" == "cont_may210" $include "./modules/14_yields/cont_may210/realization.gms"
