...
* model hash ID 5860897949b623d66f6d6ec7afc6a537638a96da
 ...
 q14_yield_past(j2,w)..
*   vm_yld(j2,"pasture","rainfed") =e= v14_past_yld(j2) * (10000 * 2.25/1e6) * s14_corr_fact * sum(cell(i2,j2),f14_yld_calib(i2,"past"));
   vm_yld(j2,"pasture","rainfed") =e= v14_past_yld(j2) * (10000 * 2.25/1e6) * sum(cell(i2,j2),vm_relax(i2));
 display vm_relax;
