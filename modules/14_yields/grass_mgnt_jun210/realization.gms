...
*' @description The grass_mgnt_jun210 realization reads in the LPJmL data and
...
$Ifi "%phase%" == "sets" $include "./modules/14_yields/grass_mgnt_jun210/sets.gms"
$Ifi "%phase%" == "declarations" $include "./modules/14_yields/grass_mgnt_jun210/declarations.gms"
$Ifi "%phase%" == "input" $include "./modules/14_yields/grass_mgnt_jun210/input.gms"
$Ifi "%phase%" == "equations" $include "./modules/14_yields/grass_mgnt_jun210/equations.gms"
$Ifi "%phase%" == "preloop" $include "./modules/14_yields/grass_mgnt_jun210/preloop.gms"
$Ifi "%phase%" == "presolve" $include "./modules/14_yields/grass_mgnt_jun210/presolve.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/14_yields/grass_mgnt_jun210/postsolve.gms"
$Ifi "%phase%" == "nl_fix" $include "./modules/14_yields/grass_mgnt_jun210/nl_fix.gms"
$Ifi "%phase%" == "nl_release" $include "./modules/14_yields/grass_mgnt_jun210/nl_release.gms"
