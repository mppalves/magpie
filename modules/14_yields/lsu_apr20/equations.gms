...
q14_inlsu(j2,lnp1)..  v14_inlsu(j2,lnp1) =e= sum(in_lsu_p, v14_lsu(j2) * f14_w1(in_lsu_p,lnp1));
...
q14_maxlsu(j2)..  v14_lsu(j2) =l= 2;
q14_minlsu(j2)..  v14_lsu(j2) =g= -2;
q14_rlsu(j2)..  vm_rlsu(j2) =e= v14_lsu(j2) * s14_std + s14_mean;
