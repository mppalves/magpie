...
$ondelim
$include "./modules/14_yields/input/055a17_p_weights_1.csv"
$offdelim
;
table f14_w2(lnp1,lnp2) weight
$ondelim
$include "./modules/14_yields/input/055a17_p_weights_2.csv"
$offdelim
;
table f14_w3(lnp2,lnp3) weight
$ondelim
$include "./modules/14_yields/input/055a17_p_weights_3.csv"
$offdelim
;
table f14_w4(lnp3,lnp4) weight
$ondelim
$include "./modules/14_yields/input/055a17_p_weights_4.csv"
$offdelim
;
table f14_w5(lnp4,lnp5) weight
$ondelim
$include "./modules/14_yields/input/055a17_p_weights_5.csv"
$offdelim
;
table f14_w6(lnp5,lnp6) weight
$ondelim
$include "./modules/14_yields/input/055a17_p_weights_6.csv"
$offdelim
;
table f14_w7(lnp6,lnp7) weight
$ondelim
$include "./modules/14_yields/input/055a17_p_weights_7.csv"
$offdelim
;
parameter f14_b1(lnp1) bias
/
$ondelim
$include "./modules/14_yields/input/055a17_p_bias_1.csv"
$offdelim
/;
parameter f14_b2(lnp2) bias
/
$ondelim
$include "./modules/14_yields/input/055a17_p_bias_2.csv"
$offdelim
/;
parameter f14_b3(lnp3) bias
/
$ondelim
$include "./modules/14_yields/input/055a17_p_bias_3.csv"
$offdelim
/;
parameter f14_b4(lnp4) bias
/
$ondelim
$include "./modules/14_yields/input/055a17_p_bias_4.csv"
$offdelim
/;
parameter f14_b5(lnp5) bias
/
$ondelim
$include "./modules/14_yields/input/055a17_p_bias_5.csv"
$offdelim
/;
parameter f14_b6(lnp6) bias
/
$ondelim
$include "./modules/14_yields/input/055a17_p_bias_6.csv"
$offdelim
/;
parameter f14_b7(lnp7) bias
/
$ondelim
$include "./modules/14_yields/input/055a17_p_bias_7.csv"
$offdelim
/;
