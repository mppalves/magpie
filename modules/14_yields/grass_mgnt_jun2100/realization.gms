...
*' @description The grass_mgnt_jun2100 realization reads in the LPJmL data and
...
$Ifi "%phase%" == "sets" $include "./modules/14_yields/grass_mgnt_jun2100/sets.gms"
$Ifi "%phase%" == "declarations" $include "./modules/14_yields/grass_mgnt_jun2100/declarations.gms"
$Ifi "%phase%" == "input" $include "./modules/14_yields/grass_mgnt_jun2100/input.gms"
$Ifi "%phase%" == "equations" $include "./modules/14_yields/grass_mgnt_jun2100/equations.gms"
$Ifi "%phase%" == "preloop" $include "./modules/14_yields/grass_mgnt_jun2100/preloop.gms"
$Ifi "%phase%" == "presolve" $include "./modules/14_yields/grass_mgnt_jun2100/presolve.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/14_yields/grass_mgnt_jun2100/postsolve.gms"
$Ifi "%phase%" == "nl_fix" $include "./modules/14_yields/grass_mgnt_jun2100/nl_fix.gms"
$Ifi "%phase%" == "nl_release" $include "./modules/14_yields/grass_mgnt_jun2100/nl_release.gms"
