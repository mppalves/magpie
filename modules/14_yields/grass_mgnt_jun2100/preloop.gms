...
i14_grassl_yld_hist_reg(t,i,past_mngt)
;
...
p14_grass_corr(t,i,past_mngt)$(p14_grass_corr(t,i,past_mngt) < 1) = 1;
...
loop(t,
     if(sum(sameas(t,"y1995"),1)=1,
          ...
          Elseif (s14_limit_calib =1 ),
               i14_lambda_grass(t,i,past_mngt) =
                    1$(f14_grassl_yld_hist_reg(t,i,past_mngt) <= p14_grass_yields(t,i,past_mngt))
                    + sqrt(p14_grass_yields(t,i,past_mngt)/f14_grassl_yld_hist_reg(t,i,past_mngt))$
                    (f14_grassl_yld_hist_reg(t,i,past_mngt) > p14_grass_yields(t,i,past_mngt));
          );

          i14_grassl_yld_hist_reg(t,i,past_mngt) = f14_grassl_yld_hist_reg(t,i,past_mngt);
