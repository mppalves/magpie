...
q14_maxlsu(j2)..  vm_lsu(ct,j2) =l= 2.5;
q14_minlsu(j2)..  vm_lsu(ct,j2) =g= -2.5;
...
q14_yield_past(j2,w)..
     vm_yld(j2,"pasture","rainfed") =e= sum(ct, v14_past_yld(j2) * f14_correction(ct, j2) * (10000 * 2.21 / 1e6));
