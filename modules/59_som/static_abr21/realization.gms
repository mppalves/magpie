...
*' @description The static_apr21 realization is built on the IPCC 2006 Guidelines for
...
$Ifi "%phase%" == "sets" $include "./modules/59_som/static_apr21/sets.gms"
$Ifi "%phase%" == "declarations" $include "./modules/59_som/static_apr21/declarations.gms"
$Ifi "%phase%" == "input" $include "./modules/59_som/static_apr21/input.gms"
$Ifi "%phase%" == "equations" $include "./modules/59_som/static_apr21/equations.gms"
$Ifi "%phase%" == "preloop" $include "./modules/59_som/static_apr21/preloop.gms"
$Ifi "%phase%" == "presolve" $include "./modules/59_som/static_apr21/presolve.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/59_som/static_apr21/postsolve.gms"
