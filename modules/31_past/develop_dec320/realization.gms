...
$Ifi "%phase%" == "declarations" $include "./modules/31_past/develop_dec320/declarations.gms"
$Ifi "%phase%" == "input" $include "./modules/31_past/develop_dec320/input.gms"
$Ifi "%phase%" == "equations" $include "./modules/31_past/develop_dec320/equations.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/31_past/develop_dec320/postsolve.gms"
$Ifi "%phase%" == "presolve" $include "./modules/31_past/develop_dec320/presolve.gms"
