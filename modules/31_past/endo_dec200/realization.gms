...
$Ifi "%phase%" == "sets" $include "./modules/31_past/endo_dec200/sets.gms"
$Ifi "%phase%" == "declarations" $include "./modules/31_past/endo_dec200/declarations.gms"
$Ifi "%phase%" == "input" $include "./modules/31_past/endo_dec200/input.gms"
$Ifi "%phase%" == "equations" $include "./modules/31_past/endo_dec200/equations.gms"
$Ifi "%phase%" == "presolve" $include "./modules/31_past/endo_dec200/presolve.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/31_past/endo_dec200/postsolve.gms"
