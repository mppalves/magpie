...
$Ifi "%phase%" == "declarations" $include "./modules/31_past/develop_a_nov20/declarations.gms"
$Ifi "%phase%" == "input" $include "./modules/31_past/develop_a_nov20/input.gms"
$Ifi "%phase%" == "equations" $include "./modules/31_past/develop_a_nov20/equations.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/31_past/develop_a_nov20/postsolve.gms"
