...
*#################### R SECTION START (OUTPUT DEFINITIONS) #####################
 ov31_past_area(t,j,kpm,w,"marginal") = v31_past_area.m(j,kpm,w);
 ov31_grazing_prod(t,j,"marginal")    = v31_grazing_prod.m(j);
 ov31_mowing_prod(t,j,"marginal")     = v31_mowing_prod.m(j);
 ...
 oq31_grazing_prod(t,j,"marginal")    = q31_grazing_prod.m(j);
 oq31_mowing_prod(t,j,"marginal")     = q31_mowing_prod.m(j);
 oq31_prod_pm(t,j,kpm,"marginal")     = q31_prod_pm.m(j,kpm);
 ...
 ov31_past_area(t,j,kpm,w,"level")    = v31_past_area.l(j,kpm,w);
 ov31_grazing_prod(t,j,"level")       = v31_grazing_prod.l(j);
 ov31_mowing_prod(t,j,"level")        = v31_mowing_prod.l(j);
 ...
 oq31_grazing_prod(t,j,"level")       = q31_grazing_prod.l(j);
 oq31_mowing_prod(t,j,"level")        = q31_mowing_prod.l(j);
 oq31_prod_pm(t,j,kpm,"level")        = q31_prod_pm.l(j,kpm);
 ...
 ov31_past_area(t,j,kpm,w,"upper")    = v31_past_area.up(j,kpm,w);
 ov31_grazing_prod(t,j,"upper")       = v31_grazing_prod.up(j);
 ov31_mowing_prod(t,j,"upper")        = v31_mowing_prod.up(j);
 ...
 oq31_grazing_prod(t,j,"upper")       = q31_grazing_prod.up(j);
 oq31_mowing_prod(t,j,"upper")        = q31_mowing_prod.up(j);
 oq31_prod_pm(t,j,kpm,"upper")        = q31_prod_pm.up(j,kpm);
 ...
 ov31_past_area(t,j,kpm,w,"lower")    = v31_past_area.lo(j,kpm,w);
 ov31_grazing_prod(t,j,"lower")       = v31_grazing_prod.lo(j);
 ov31_mowing_prod(t,j,"lower")        = v31_mowing_prod.lo(j);
 ...
 oq31_grazing_prod(t,j,"lower")       = q31_grazing_prod.lo(j);
 oq31_mowing_prod(t,j,"lower")        = q31_mowing_prod.lo(j);
 oq31_prod_pm(t,j,kpm,"lower")        = q31_prod_pm.lo(j,kpm);
